...
用法::
    ...
    python tests/manual/ops/scheduler.py

    # 指定设备和次数
    python tests/manual/ops/scheduler.py 127.0.0.1:16384 --times 10

    # 使用自定义 YAML
    python tests/manual/ops/scheduler.py --plan examples/plans/event/20260212/Ex5A夜战.yaml --times 50
