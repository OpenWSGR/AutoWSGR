...
用法::
    ...
    # 自动检测设备，默认 1 次
    python tests/manual/ops/normal_fight.py

    # 指定设备 serial 和次数
    python tests/manual/ops/normal_fight.py 127.0.0.1:16384 3

    # 使用自定义 YAML 计划
    python tests/manual/ops/normal_fight.py --plan examples/plans/normal_fight/7-46SS-all.yaml
