...
用法::
    ...
    python tests/manual/ops/exercise.py
    python tests/manual/ops/exercise.py 127.0.0.1:16384

    # 指定舰队和对手 (对手编号 1-5，不传则挑战所有可用对手)
    python tests/manual/ops/exercise.py 127.0.0.1:16384 --fleet 2 --rival 3
